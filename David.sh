...
echo  $white"[#]> MilwOrm Cyber Team Was 
...
echo $white"Author : Mr.X TIKUSBERDASI"

echo $white"Team : MilwOrm Cyber Team"

echo $white"Thanks To : MR.X TIKUSBERDASI"

echo $white"thanks To : Insomnia Cyber Team" 
